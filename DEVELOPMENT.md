...
|---|---|---|---|---|
| **Quick** | ~8 | 3–5 min | A writer who has never made a sheet, or a large secondary cast | *"Get the essentials down for everyone."* |
| **Standard** | ~22 | 20–30 min | The default. A character the story actually depends on | *"Enough for a collaborator to write them correctly."* |
| **Deep** | ~55 | An afternoon | The protagonist, the antagonist, a series anchor | *"Every question you have not asked yet."* |
...
- Completing a Quick profile shows a single, quiet prompt: *"Make this one Deep — there are 47 questions you haven't been asked yet."* This is a soft upsell of *effort*, not of payment, and it maps directly to the Story Bible's Characters section.
...
| Sample lines (2–3) | P2 | |
| Continuity questions | P0 | Auto-generated open questions for this character (§6.2) |
| Canon facts — must not change | P0 | The protected-canon list that becomes the collaborator brief (§5.8) |
| Open threads | P1 | *What is still undecided about them* |
